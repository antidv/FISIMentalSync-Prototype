...
const grupos = [
  ...
  { enlace: './informe-colectivo.html', icon: 'fa-regular fa-file-lines', texto: 'Informe Colectivo' },
  { enlace: '../page-inicio/login.html', icon: 'fa-solid fa-arrow-right-from-bracket', texto: 'Cerrar sesión' }
];
